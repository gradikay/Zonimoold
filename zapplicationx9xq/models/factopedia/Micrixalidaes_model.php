...
//class Factopedia_model extends CI_Model{
    class Micrixalidaes_model extends CI_Model{
      
     // Return all the row in the dogs' table
     // This will be use for pagination for the "total_rows"
     public function record_count(){
         return $this->db->count_all('micrixalidaes'); 
     }
    
     // This retrieves the list of all the recods from the this model's table
     public function fetch_micrixalidaes($limit, $start) {
        $this->db->limit($limit, $start);
        $this->db->select('*') ;
        $this->db->from('micrixalidaes AS D') ;
        $this->db->order_by("name", "asc");
        $this->db->join('micrixalidaes_first_image  AS F', 'D.name = F.animal_name','left') ;
        $this->db->join('micrixalidaes_second_image AS S', 'D.name = S.animal_name','left') ;
        $this->db->join('micrixalidaes_third_image  AS T', 'D.name = T.animal_name','left') ;
        $this->db->join('micrixalidaes_fourth_image AS R', 'D.name = R.animal_name','left') ;
        $query = $this->db->get();
 ...
 */
    public function get_micrixalidae_details($id){
        $this->db->select('*');
        $this->db->from('micrixalidaes');
        $this->db->where('id', $id);
        $query = $this->db->get();
        return $query->row();
    }
    
    public function get_micrixalidae_databases(){
        $this->db->select('*');
        $this->db->from('section AS S');
        $this->db->join('micrixalidaes AS D', 'S.section_id = D.section_id', 'INNER');
...
//Update the animal data selected here we have the dogs' table
    ...
    public function micrixalidaes_do_upload_first(){
        $username = $this->session->userdata('username');
        // You can call any of this items using the cariable 
            // $upload_data
			$data = array('upload_data' => $this->upload->data());
        ...
        //We are escaping from space and quotes
        // We are assigning the table row to some value
            $sql = "UPDATE micrixalidaes_first_image            
    ...
    public function micrixalidaes_do_upload_second(){
        $username = $this->session->userdata('username');
        // You can call any of this items using the cariable 
            // $upload_data
			$data = array('upload_data' => $this->upload->data());
        ...
        //We are escaping from space and quotes
        // We are assigning the table row to some value
            $sql = "UPDATE micrixalidaes_second_image            
    ...
    public function micrixalidaes_do_upload_third(){
        $username = $this->session->userdata('username');
        // You can call any of this items using the cariable 
            // $upload_data
			$data = array('upload_data' => $this->upload->data());
        ...
        //We are escaping from space and quotes
        // We are assigning the table row to some value
            $sql = "UPDATE micrixalidaes_third_image            
    ...
    public function micrixalidaes_do_upload_fourth(){
        $username = $this->session->userdata('username');
        // You can call any of this items using the cariable 
            // $upload_data
			$data = array('upload_data' => $this->upload->data());
        ...
        //We are escaping from space and quotes
        // We are assigning the table row to some value
            $sql = "UPDATE micrixalidaes_fourth_image            
