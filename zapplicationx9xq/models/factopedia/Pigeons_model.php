...
//class Factopedia_model extends CI_Model{
    class Pigeons_model extends CI_Model{
     
     // Return all the row in the pigeons' table
     // This will be use for pagination for the "total_rows"
     public function record_count(){
         
         return $this->db->count_all('pigeons');
         
     }
    
     // This retrieves the list of all the recods from the pigeons' table
     public function fetch_pigeons($limit, $start) {
         
        $this->db->limit($limit, $start);
        $this->db->select('*') ;
        $this->db->from('pigeons AS D') ;
        $this->db->order_by("name", "asc");
        $this->db->join('pigeons_first_image  AS F', 'D.name = F.animal_name','left') ;
        $this->db->join('pigeons_second_image AS S', 'D.name = S.animal_name','left') ;
        $this->db->join('pigeons_third_image  AS T', 'D.name = T.animal_name','left') ;
        $this->db->join('pigeons_fourth_image AS R', 'D.name = R.animal_name','left') ;
        $query = $this->db->get();
...
/*
 ********************* Pigeons' table settings
 */
    public function get_pigeon_details($id){
        $this->db->select('*');
        $this->db->from('pigeons');
        $this->db->where('id', $id);
        $query = $this->db->get();
        return $query->row();
    }
    
    public function get_pigeon_databases(){
        $this->db->select('*');
        $this->db->from('section AS S');
        $this->db->join('pigeons AS D', 'S.section_id = D.section_id', 'INNER');
...
//Update the animal data selected here we have the pigeons' table
    
     public function update(){
          // This is the setting for the editing part of pigeons' page
            ...
            $pigeon_function = $this->input->post('nkTdZQcYAo');
        ...
        // We are assigning the table row to some value
            $sql = "UPDATE pigeons            
                    SET other_name   = " . $this->db->escape($other_name) . ",
                        ...
                        pigeon_function = " . $this->db->escape($pigeon_function) . ",
    ...
    public function pigeons_do_upload_first(){
        $username = $this->session->userdata('username');
        ...
        //We are escaping from space and quotes
        // We are assigning the table row to some value
            $sql = "UPDATE pigeons_first_image            
    ...
    public function pigeons_do_upload_second(){
        $username = $this->session->userdata('username');
        // You can call any of this items using the cariable 
            // $upload_data
			$data = array('upload_data' => $this->upload->data());
        ...
        //We are escaping from space and quotes
        // We are assigning the table row to some value
            $sql = "UPDATE pigeons_second_image            
    ...
    public function pigeons_do_upload_third(){
        $username = $this->session->userdata('username');
        // You can call any of this items using the cariable 
            // $upload_data
			$data = array('upload_data' => $this->upload->data());
        ...
        //We are escaping from space and quotes
        // We are assigning the table row to some value
            $sql = "UPDATE pigeons_third_image            
    ...
    public function pigeons_do_upload_fourth(){
        $username = $this->session->userdata('username');
        ...
        //We are escaping from space and quotes
        // We are assigning the table row to some value
            $sql = "UPDATE pigeons_fourth_image            
