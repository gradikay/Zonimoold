...
//class Factopedia_model extends CI_Model{
    class Horses_model extends CI_Model{
     ...
     // Return all the row in the horses' table
     // This will be use for pagination for the "total_rows"
     public function record_count(){
         
         return $this->db->count_all('horses');
         
     }
    
     // This retrieves the list of all the recods from the horses' table
     public function fetch_horses($limit, $start) {
         
        $this->db->limit($limit, $start);
        $this->db->select('*') ;
        $this->db->from('horses AS D') ;
        $this->db->order_by("name", "asc");
        $this->db->join('horses_first_image  AS F', 'D.name = F.animal_name','left') ;
        $this->db->join('horses_second_image AS S', 'D.name = S.animal_name','left') ;
        $this->db->join('horses_third_image  AS T', 'D.name = T.animal_name','left') ;
        $this->db->join('horses_fourth_image AS R', 'D.name = R.animal_name','left') ;
        $query = $this->db->get();
...
/*
 ********************* Horses' table settings
 */
    public function get_horse_details($id){
        $this->db->select('*');
        $this->db->from('horses');
        $this->db->where('id', $id);
        $query = $this->db->get();
    ...
    public function get_horse_databases(){
        $this->db->select('*');
        $this->db->from('section AS S');
        $this->db->join('horses AS D', 'S.section_id = D.section_id', 'INNER');
...
//Update the animal data selected here we have the horses' table
    
     public function update(){
          // This is the setting for the editing part of horses' page
          // OLD CODE
        /* $data = array(
            ...
            'horse_function'=> $this->input->post('horse_function'),
            ...
            $horse_function = $this->input->post('nkTdZQcYAo');
        ...
        // We are assigning the table row to some value
            $sql = "UPDATE horses            
                    SET other_name   = " . $this->db->escape($other_name) . ",
                        ...
                        horse_function = " . $this->db->escape($horse_function) . ",
    ...
    public function horses_do_upload_first(){
        $username = $this->session->userdata('username');
    ...
    public function horses_do_upload_second(){
        $username = $this->session->userdata('username');
        // You can call any of this items using the cariable 
            // $upload_data
			$data = array('upload_data' => $this->upload->data());
        ...
        //We are escaping from space and quotes
        // We are assigning the table row to some value
            $sql = "UPDATE horses_second_image            
    ...
    public function horses_do_upload_third(){
        $username = $this->session->userdata('username');
        // You can call any of this items using the cariable 
            // $upload_data
			$data = array('upload_data' => $this->upload->data());
    ...
    public function horses_do_upload_fourth(){
        $username = $this->session->userdata('username');
        ...
        //We are escaping from space and quotes
        // We are assigning the table row to some value
            $sql = "UPDATE horses_fourth_image            
