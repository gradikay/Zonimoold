...
//class Factopedia_model extends CI_Model{
    class Ponys_model extends CI_Model{
     
     // Return all the row in the ponys' table
     // This will be use for pagination for the "total_rows"
     public function record_count(){
         
         return $this->db->count_all('ponys');
         
     }
    
     // This retrieves the list of all the recods from the ponys' table
     public function fetch_ponys($limit, $start) {
         
        $this->db->limit($limit, $start);
        $this->db->select('*') ;
        $this->db->from('ponys AS D') ;
        $this->db->order_by("name", "asc");
        $this->db->join('ponys_first_image  AS F', 'D.name = F.animal_name','left') ;
        $this->db->join('ponys_second_image AS S', 'D.name = S.animal_name','left') ;
        $this->db->join('ponys_third_image  AS T', 'D.name = T.animal_name','left') ;
        $this->db->join('ponys_fourth_image AS R', 'D.name = R.animal_name','left') ;
        $query = $this->db->get();
...
/*
 ********************* Ponys' table settings
 */
    public function get_pony_details($id){
        $this->db->select('*');
        $this->db->from('ponys');
        $this->db->where('id', $id);
        $query = $this->db->get();
    ...
    public function get_pony_databases(){
        $this->db->select('*');
        $this->db->from('section AS S');
        $this->db->join('ponys AS D', 'S.section_id = D.section_id', 'INNER');
...
//Update the animal data selected here we have the ponys' table
    
     public function update(){
          // This is the setting for the editing part of ponys' page
          // OLD CODE
        /* $data = array(
            ...
            'pony_function'=> $this->input->post('pony_function'),
            ...
            $pony_function = $this->input->post('nkTdZQcYAo');
        ...
        // We are assigning the table row to some value
            $sql = "UPDATE ponys            
                    SET other_name   = " . $this->db->escape($other_name) . ",
                        ...
                        pony_function = " . $this->db->escape($pony_function) . ",
    ...
    public function ponys_do_upload_first(){
        $username = $this->session->userdata('username');
    ...
    public function ponys_do_upload_second(){
        $username = $this->session->userdata('username');
        // You can call any of this items using the cariable 
            // $upload_data
			$data = array('upload_data' => $this->upload->data());
    ...
    public function ponys_do_upload_third(){
        $username = $this->session->userdata('username');
        // You can call any of this items using the cariable 
            // $upload_data
			$data = array('upload_data' => $this->upload->data());
    ...
    public function ponys_do_upload_fourth(){
        $username = $this->session->userdata('username');
