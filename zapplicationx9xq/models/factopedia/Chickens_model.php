...
//class Factopedia_model extends CI_Model{
    class Chickens_model extends CI_Model{
     
     // Return all the row in the chickens' table
     // This will be use for pagination for the "total_rows"
     public function record_count(){
         
         return $this->db->count_all('chickens');
         
     }
    
     // This retrieves the list of all the recods from the chickens' table
     public function fetch_chickens($limit, $start) {
         
        $this->db->limit($limit, $start);
        $this->db->select('*') ;
        $this->db->from('chickens AS D') ;
        $this->db->order_by("name", "asc");
        $this->db->join('chickens_first_image  AS F', 'D.name = F.animal_name','left') ;
        $this->db->join('chickens_second_image AS S', 'D.name = S.animal_name','left') ;
        $this->db->join('chickens_third_image  AS T', 'D.name = T.animal_name','left') ;
        $this->db->join('chickens_fourth_image AS R', 'D.name = R.animal_name','left') ;
        $query = $this->db->get();
...
/*
 ********************* Chickens' table settings
 */
    public function get_chicken_details($id){
        $this->db->select('*');
        $this->db->from('chickens');
        $this->db->where('id', $id);
        $query = $this->db->get();
        return $query->row();
    }
    
    public function get_chicken_databases(){
        $this->db->select('*');
        $this->db->from('section AS S');
        $this->db->join('chickens AS D', 'S.section_id = D.section_id', 'INNER');
...
//Update the animal data selected here we have the chickens' table
    
     public function update(){
          // This is the setting for the editing part of chickens' page
          // OLD CODE
        /* $data = array(
            ...
            'chicken_function'=> $this->input->post('chicken_function'),
            ...
            $chicken_function = $this->input->post('nkTdZQcYAo');
        ...
        // We are assigning the table row to some value
            $sql = "UPDATE chickens            
                    SET other_name   = " . $this->db->escape($other_name) . ",
                        ...
                        chicken_function = " . $this->db->escape($chicken_function) . ",
    ...
    public function chickens_do_upload_first(){
        $username = $this->session->userdata('username');
        ...
        //We are escaping from space and quotes
        // We are assigning the table row to some value
            $sql = "UPDATE chickens_first_image            
    ...
    public function chickens_do_upload_second(){
        $username = $this->session->userdata('username');
        // You can call any of this items using the cariable 
            // $upload_data
			$data = array('upload_data' => $this->upload->data());
        ...
        //We are escaping from space and quotes
        // We are assigning the table row to some value
            $sql = "UPDATE chickens_second_image            
    ...
    public function chickens_do_upload_third(){
        $username = $this->session->userdata('username');
        // You can call any of this items using the cariable 
            // $upload_data
			$data = array('upload_data' => $this->upload->data());
        ...
        //We are escaping from space and quotes
        // We are assigning the table row to some value
            $sql = "UPDATE chickens_third_image            
    ...
    public function chickens_do_upload_fourth(){
        $username = $this->session->userdata('username');
        ...
        //We are escaping from space and quotes
        // We are assigning the table row to some value
            $sql = "UPDATE chickens_fourth_image            
