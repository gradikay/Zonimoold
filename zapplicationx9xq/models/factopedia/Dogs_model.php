...
//class Factopedia_model extends CI_Model{
    class Dogs_model extends CI_Model{
     ...
     public function fetch_dogs($limit, $start) {
        ...
        $this->db->join('dogs_first_image  AS F', 'D.name = F.animal_name','left') ;
        $this->db->join('dogs_second_image AS S', 'D.name = S.animal_name','left') ;
        $this->db->join('dogs_third_image  AS T', 'D.name = T.animal_name','left') ;
        $this->db->join('dogs_fourth_image AS R', 'D.name = R.animal_name','left') ;
        $query = $this->db->get();
...
//Update the animal data selected here we have the dogs' table
     ...
     public function update(){
        ...
        /* $data = array(
            ...
            $dog_function = $this->input->post('nkTdZQcYAo');
    ...
    public function dogs_do_upload_first(){
        $username = $this->session->userdata('username');
    ...
    public function dogs_do_upload_second(){
        $username = $this->session->userdata('username');
        // You can call any of this items using the cariable 
            // $upload_data
			$data = array('upload_data' => $this->upload->data());
    ...
    public function dogs_do_upload_third(){
        $username = $this->session->userdata('username');
        // You can call any of this items using the cariable 
            // $upload_data
			$data = array('upload_data' => $this->upload->data());
    ...
    public function dogs_do_upload_fourth(){
        $username = $this->session->userdata('username');
