...
//class Factopedia_model extends CI_Model{
    class Pigs_model extends CI_Model{
     
     // Return all the row in the pigs' table
     // This will be use for pagination for the "total_rows"
     public function record_count(){
         
         return $this->db->count_all('pigs');
         
     }
    
     // This retrieves the list of all the recods from the pigs' table
     public function fetch_pigs($limit, $start) {
         
        $this->db->limit($limit, $start);
        $this->db->select('*') ;
        $this->db->from('pigs AS D') ;
        $this->db->order_by("name", "asc");
        $this->db->join('pigs_first_image  AS F', 'D.name = F.animal_name','left') ;
        $this->db->join('pigs_second_image AS S', 'D.name = S.animal_name','left') ;
        $this->db->join('pigs_third_image  AS T', 'D.name = T.animal_name','left') ;
        $this->db->join('pigs_fourth_image AS R', 'D.name = R.animal_name','left') ;
        $query = $this->db->get();
 ...
 ********************* Pigs' table settings
 */
    public function get_pig_details($id){
        $this->db->select('*');
        $this->db->from('pigs');
        $this->db->where('id', $id);
        $query = $this->db->get();
    ...
    public function get_pig_databases(){
        $this->db->select('*');
        $this->db->from('section AS S');
        $this->db->join('pigs AS D', 'S.section_id = D.section_id', 'INNER');
...
//Update the animal data selected here we have the pigs' table
    
     public function update(){
          // This is the setting for the editing part of pigs' page
          // OLD CODE
        /* $data = array(
            ...
            'pig_function'=> $this->input->post('pig_function'),
            ...
            $pig_function = $this->input->post('nkTdZQcYAo');
        ...
        // We are assigning the table row to some value
            $sql = "UPDATE pigs            
                    SET other_name   = " . $this->db->escape($other_name) . ",
                        ...
                        pig_function = " . $this->db->escape($pig_function) . ",
    ...
    public function pigs_do_upload_first(){
        $username = $this->session->userdata('username');
    ...
    public function pigs_do_upload_second(){
        $username = $this->session->userdata('username');
        // You can call any of this items using the cariable 
            // $upload_data
			$data = array('upload_data' => $this->upload->data());
    ...
    public function pigs_do_upload_third(){
        $username = $this->session->userdata('username');
        // You can call any of this items using the cariable 
            // $upload_data
			$data = array('upload_data' => $this->upload->data());
    ...
    public function pigs_do_upload_fourth(){
        $username = $this->session->userdata('username');
