...
//class Factopedia_model extends CI_Model{
    class Goats_model extends CI_Model{
     
     // Return all the row in the goats' table
     // This will be use for pagination for the "total_rows"
     public function record_count(){
         
         return $this->db->count_all('goats');
         
     }
    
     // This retrieves the list of all the recods from the goats' table
     public function fetch_goats($limit, $start) {
         
        $this->db->limit($limit, $start);
        $this->db->select('*') ;
        $this->db->from('goats AS D') ;
        $this->db->order_by("name", "asc");
        $this->db->join('goats_first_image  AS F', 'D.name = F.animal_name','left') ;
        $this->db->join('goats_second_image AS S', 'D.name = S.animal_name','left') ;
        $this->db->join('goats_third_image  AS T', 'D.name = T.animal_name','left') ;
        $this->db->join('goats_fourth_image AS R', 'D.name = R.animal_name','left') ;
        $query = $this->db->get();
...
/*
 ********************* Goats' table settings
 */
    public function get_goat_details($id){
        $this->db->select('*');
        $this->db->from('goats');
        $this->db->where('id', $id);
        $query = $this->db->get();
    ...
    public function get_goat_databases(){
        $this->db->select('*');
        $this->db->from('section AS S');
        $this->db->join('goats AS D', 'S.section_id = D.section_id', 'INNER');
...
//Update the animal data selected here we have the goats' table
    
     public function update(){
          // This is the setting for the editing part of goats' page
          // OLD CODE
        /* $data = array(
            ...
            'goat_function'=> $this->input->post('goat_function'),
            ...
            $goat_function = $this->input->post('nkTdZQcYAo');
        ...
        // We are assigning the table row to some value
            $sql = "UPDATE goats            
                    SET other_name   = " . $this->db->escape($other_name) . ",
                        ...
                        goat_function = " . $this->db->escape($goat_function) . ",
    ...
    public function goats_do_upload_first(){
        $username = $this->session->userdata('username');
    ...
    public function goats_do_upload_second(){
        $username = $this->session->userdata('username');
        // You can call any of this items using the cariable 
            // $upload_data
			$data = array('upload_data' => $this->upload->data());
    ...
    public function goats_do_upload_third(){
        $username = $this->session->userdata('username');
        // You can call any of this items using the cariable 
            // $upload_data
			$data = array('upload_data' => $this->upload->data());
    ...
    public function goats_do_upload_fourth(){
        $username = $this->session->userdata('username');
