...
//class Factopedia_model extends CI_Model{
    class Donkeys_model extends CI_Model{
     
     // Return all the row in the donkeys' table
     // This will be use for pagination for the "total_rows"
     public function record_count(){
         
         return $this->db->count_all('donkeys');
         
     }
    
     // This retrieves the list of all the recods from the donkeys' table
     public function fetch_donkeys($limit, $start) {
         
        $this->db->limit($limit, $start);
        $this->db->select('*') ;
        $this->db->from('donkeys AS D') ;
        $this->db->order_by("name", "asc");
        $this->db->join('donkeys_first_image  AS F', 'D.name = F.animal_name','left') ;
        $this->db->join('donkeys_second_image AS S', 'D.name = S.animal_name','left') ;
        $this->db->join('donkeys_third_image  AS T', 'D.name = T.animal_name','left') ;
        $this->db->join('donkeys_fourth_image AS R', 'D.name = R.animal_name','left') ;
        $query = $this->db->get();
...
/*
 ********************* Donkeys' table settings
 */
    public function get_donkey_details($id){
        $this->db->select('*');
        $this->db->from('donkeys');
        $this->db->where('id', $id);
        $query = $this->db->get();
        return $query->row();
    }
    
    public function get_donkey_databases(){
        $this->db->select('*');
        $this->db->from('section AS S');
        $this->db->join('donkeys AS D', 'S.section_id = D.section_id', 'INNER');
...
//Update the animal data selected here we have the donkeys' table
    
     public function update(){
          // This is the setting for the editing part of donkeys' page
          // OLD CODE
        /* $data = array(
            ...
            'donkey_function'=> $this->input->post('donkey_function'),
            ...
            $donkey_function = $this->input->post('nkTdZQcYAo');
        ...
        // We are assigning the table row to some value
            $sql = "UPDATE donkeys            
                    SET other_name   = " . $this->db->escape($other_name) . ",
                        ...
                        donkey_function = " . $this->db->escape($donkey_function) . ",
    ...
    public function donkeys_do_upload_first(){
        $username = $this->session->userdata('username');
        ...
        //We are escaping from space and quotes
        // We are assigning the table row to some value
            $sql = "UPDATE donkeys_first_image            
    ...
    public function donkeys_do_upload_second(){
        $username = $this->session->userdata('username');
        // You can call any of this items using the cariable 
            // $upload_data
			$data = array('upload_data' => $this->upload->data());
        ...
        //We are escaping from space and quotes
        // We are assigning the table row to some value
            $sql = "UPDATE donkeys_second_image            
    ...
    public function donkeys_do_upload_third(){
        $username = $this->session->userdata('username');
        // You can call any of this items using the cariable 
            // $upload_data
			$data = array('upload_data' => $this->upload->data());
        ...
        //We are escaping from space and quotes
        // We are assigning the table row to some value
            $sql = "UPDATE donkeys_third_image            
    ...
    public function donkeys_do_upload_fourth(){
        $username = $this->session->userdata('username');
        ...
        //We are escaping from space and quotes
        // We are assigning the table row to some value
            $sql = "UPDATE donkeys_fourth_image            
