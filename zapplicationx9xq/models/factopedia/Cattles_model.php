...
//class Factopedia_model extends CI_Model{
    class Cattles_model extends CI_Model{
     
     // Return all the row in the cattles' table
     // This will be use for pagination for the "total_rows"
     public function record_count(){
         
         return $this->db->count_all('cattles');
         
     }
    
     // This retrieves the list of all the recods from the cattles' table
     public function fetch_cattles($limit, $start) {
         
        $this->db->limit($limit, $start);
        $this->db->select('*') ;
        $this->db->from('cattles AS D') ;
        $this->db->order_by("name", "asc");
        $this->db->join('cattles_first_image  AS F', 'D.name = F.animal_name','left') ;
        $this->db->join('cattles_second_image AS S', 'D.name = S.animal_name','left') ;
        $this->db->join('cattles_third_image  AS T', 'D.name = T.animal_name','left') ;
        $this->db->join('cattles_fourth_image AS R', 'D.name = R.animal_name','left') ;
        $query = $this->db->get();
...
/*
 ********************* Cattles' table settings
 */
    public function get_cattle_details($id){
        $this->db->select('*');
        $this->db->from('cattles');
        $this->db->where('id', $id);
        $query = $this->db->get();
        return $query->row();
    }
    
    public function get_cattle_databases(){
        $this->db->select('*');
        $this->db->from('section AS S');
        $this->db->join('cattles AS D', 'S.section_id = D.section_id', 'INNER');
...
//Update the animal data selected here we have the cattles' table
    
     public function update(){
          // This is the setting for the editing part of cattles' page
          // OLD CODE
        /* $data = array(
            ...
            'cattle_function'=> $this->input->post('cattle_function'),
            ...
            $cattle_function = $this->input->post('nkTdZQcYAo');
        ...
        // We are assigning the table row to some value
            $sql = "UPDATE cattles            
                    SET other_name   = " . $this->db->escape($other_name) . ",
                        ...
                        cattle_function = " . $this->db->escape($cattle_function) . ",
    ...
    public function cattles_do_upload_first(){
        $username = $this->session->userdata('username');
        ...
        //We are escaping from space and quotes
        // We are assigning the table row to some value
            $sql = "UPDATE cattles_first_image            
    ...
    public function cattles_do_upload_second(){
        $username = $this->session->userdata('username');
        // You can call any of this items using the cariable 
            // $upload_data
			$data = array('upload_data' => $this->upload->data());
        ...
        //We are escaping from space and quotes
        // We are assigning the table row to some value
            $sql = "UPDATE cattles_second_image            
    ...
    public function cattles_do_upload_third(){
        $username = $this->session->userdata('username');
        // You can call any of this items using the cariable 
            // $upload_data
			$data = array('upload_data' => $this->upload->data());
        ...
        //We are escaping from space and quotes
        // We are assigning the table row to some value
            $sql = "UPDATE cattles_third_image            
    ...
    public function cattles_do_upload_fourth(){
        $username = $this->session->userdata('username');
        ...
        //We are escaping from space and quotes
        // We are assigning the table row to some value
            $sql = "UPDATE cattles_fourth_image            
