...
//class Factopedia_model extends CI_Model{
    class Geeses_model extends CI_Model{
     
     // Return all the row in the geeses' table
     // This will be use for pagination for the "total_rows"
     public function record_count(){
         
         return $this->db->count_all('geeses');
         
     }
    
     // This retrieves the list of all the recods from the geeses' table
     public function fetch_geeses($limit, $start) {
         
        $this->db->limit($limit, $start);
        $this->db->select('*') ;
        $this->db->from('geeses AS D') ;
        $this->db->order_by("name", "asc");
        $this->db->join('geeses_first_image  AS F', 'D.name = F.animal_name','left') ;
        $this->db->join('geeses_second_image AS S', 'D.name = S.animal_name','left') ;
        $this->db->join('geeses_third_image  AS T', 'D.name = T.animal_name','left') ;
        $this->db->join('geeses_fourth_image AS R', 'D.name = R.animal_name','left') ;
        $query = $this->db->get();
...
/*
 ********************* Geeses' table settings
 */
    public function get_geese_details($id){
        $this->db->select('*');
        $this->db->from('geeses');
        $this->db->where('id', $id);
        $query = $this->db->get();
    ...
    public function get_geese_databases(){
        $this->db->select('*');
        $this->db->from('section AS S');
        $this->db->join('geeses AS D', 'S.section_id = D.section_id', 'INNER');
...
//Update the animal data selected here we have the geeses' table
    
     public function update(){
          // This is the setting for the editing part of geeses' page
          // OLD CODE
        /* $data = array(
            ...
            'geese_function'=> $this->input->post('geese_function'),
            ...
            $geese_function = $this->input->post('nkTdZQcYAo');
        ...
        // We are assigning the table row to some value
            $sql = "UPDATE geeses            
                    SET other_name   = " . $this->db->escape($other_name) . ",
                        ...
                        geese_function = " . $this->db->escape($geese_function) . ",
    ...
    public function geeses_do_upload_first(){
        $username = $this->session->userdata('username');
    ...
    public function geeses_do_upload_second(){
        $username = $this->session->userdata('username');
        // You can call any of this items using the cariable 
            // $upload_data
			$data = array('upload_data' => $this->upload->data());
        ...
        //We are escaping from space and quotes
        // We are assigning the table row to some value
            $sql = "UPDATE geeses_second_image            
    ...
    public function geeses_do_upload_third(){
        $username = $this->session->userdata('username');
        // You can call any of this items using the cariable 
            // $upload_data
			$data = array('upload_data' => $this->upload->data());
    ...
    public function geeses_do_upload_fourth(){
        $username = $this->session->userdata('username');
        ...
        //We are escaping from space and quotes
        // We are assigning the table row to some value
            $sql = "UPDATE geeses_fourth_image            
