...
class Agamidaes extends CI_Controller { 
    ...
    public function __construct()
        {
				...
				$this->model = 'factopedia/Agamidaes_model';
					// Set the variable for $redirecteur above
				$this->redirecteur = 'facto/Agamidaes/agamidaes';
 ...
 */    
    public function agamidaes(){
         ...
         * ******************** Pagination setting
         */
        $config['base_url']    = base_url(). '/facto/Agamidaes/agamidaes';
            // This gets the total row from my dogs' table pasted from dog's controller
        $config['total_rows']  = $this->Agamidaes_model->record_count();
        ...
        $data['results']      = $this->Agamidaes_model->fetch_agamidaes($config['per_page'], $page);
        ...
        $data['getAll']       = $this->Agamidaes_model->return_row_count();
		$data['getEverything']= $this->Count_model->return_all_database_count();
        $data['main_content'] = 'pagefactopedia/agamidaes';
 ...
 */   
    public function agamidae_e($id){
        ...
        $this->load->model($this->model);
             ...
             */
        $data['lists']        = $this->Agamidaes_model->get_agamidae_databases(); 
            // Call the users variable and the table name to output the result
            // Call it everywhere you want to use it 
        $data['users']        = $this->Agamidaes_model->get_users();
        $data['image']        = $this->Agamidaes_model->get_my_images($id);

		$data['im_prof']      = $this->User_model->get_im_profile();
        $data['spons']        = $this->Buyorsell_model->pets_sponsord();
        $data['sponsf']       = $this->Buyorsell_model->pets_sponsordfoot();
        $data['animal']       = $this->Agamidaes_model->get_agamidae_details($id);
        $data['main_content'] = 'pagefactopedia/editorial/agamidae_e';
 ...
 */
    public function agamidae_m($id){
        ...
        $data['sponsf']       = $this->Buyorsell_model->pets_sponsordfoot();
        $data['animal']       = $this->Agamidaes_model->get_agamidae_details($id);
        $data['main_content'] = 'pagefactopedia/learn/agamidae_m';
            /*
             * this will iclude the main.php inside layouts
             */
        $this->load->view('layouts/main',$data);
 ...
 */
    public function agamidae_i($id){
        ...
        $this->load->view('pagefactopedia/modelsimage/agamidae_i',$data);
	}
 ...
 * ************* This id is returning all the data with id request
 */
    public function agamidae_i2($id){
            // Loads the model
        $this->load->model($this->model);
        ...
        $this->load->view('pagefactopedia/modelsimage/agamidae_i2',$data);
	}
 ...
 * ************* This id is returning all the data with id request
 */
    public function agamidae_i3($id){
        ...
        $this->load->view('pagefactopedia/modelsimage/agamidae_i3',$data);
	}
 ...
 * ************* This id is returning all the data with id request
 */
    public function agamidae_i4($id){
        ...
        $this->load->view('pagefactopedia/modelsimage/agamidae_i4',$data);
	} 
 ...
 * ************* This id is returning all the data with id request
 */    
    public function agamidaes_do_upload(){ 
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->Agamidaes_model->agamidaes_do_upload();
            $this->Agamidaes_model->agamidaes_do_upload_first();
 ...
 * ************* This id is returning all the data with id request
 */ 
    public function agamidaes_do_upload2(){  
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Agamidaes_model->agamidaes_do_upload();
            $this->Agamidaes_model->agamidaes_do_upload_second();
 ...
 * ************* This id is returning all the data with id request
 */    
    public function agamidaes_do_upload3(){      
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Agamidaes_model->agamidaes_do_upload();
            $this->Agamidaes_model->agamidaes_do_upload_third();
 ...
 * ************* This id is returning all the data with id request
 */ 
    public function agamidaes_do_upload4(){  
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Agamidaes_model->agamidaes_do_upload();
            $this->Agamidaes_model->agamidaes_do_upload_fourth();
