...
class Anguidaes extends CI_Controller { 
    ...
    public function __construct()
        {
				...
				$this->model = 'factopedia/Anguidaes_model';
					// Set the variable for $redirecteur above
				$this->redirecteur = 'facto/Anguidaes/anguidaes';
 ...
 */    
    public function anguidaes(){
         ...
         * ******************** Pagination setting
         */
        $config['base_url']    = base_url(). '/facto/Anguidaes/anguidaes';
            // This gets the total row from my dogs' table pasted from dog's controller
        $config['total_rows']  = $this->Anguidaes_model->record_count();
        ...
        $data['results']      = $this->Anguidaes_model->fetch_anguidaes($config['per_page'], $page);
        ...
        $data['getAll']       = $this->Anguidaes_model->return_row_count();
		$data['getEverything']= $this->Count_model->return_all_database_count();
        $data['main_content'] = 'pagefactopedia/anguidaes';
 ...
 */   
    public function anguidae_e($id){
        ...
        $this->load->model($this->model);
             ...
             */
        $data['lists']        = $this->Anguidaes_model->get_anguidae_databases(); 
            // Call the users variable and the table name to output the result
            // Call it everywhere you want to use it 
        $data['users']        = $this->Anguidaes_model->get_users();
        $data['image']        = $this->Anguidaes_model->get_my_images($id);

		$data['im_prof']      = $this->User_model->get_im_profile();
        $data['spons']        = $this->Buyorsell_model->pets_sponsord();
        $data['sponsf']       = $this->Buyorsell_model->pets_sponsordfoot();
        $data['animal']       = $this->Anguidaes_model->get_anguidae_details($id);
        $data['main_content'] = 'pagefactopedia/editorial/anguidae_e';
 ...
 */
    public function anguidae_m($id){
        ...
        $data['sponsf']       = $this->Buyorsell_model->pets_sponsordfoot();
        $data['animal']       = $this->Anguidaes_model->get_anguidae_details($id);
        $data['main_content'] = 'pagefactopedia/learn/anguidae_m';
            /*
             * this will iclude the main.php inside layouts
             */
        $this->load->view('layouts/main',$data);
 ...
 */
    public function anguidae_i($id){
        ...
        $this->load->view('pagefactopedia/modelsimage/anguidae_i',$data);
	}
 ...
 * ************* This id is returning all the data with id request
 */
    public function anguidae_i2($id){
            // Loads the model
        $this->load->model($this->model);
        ...
        $this->load->view('pagefactopedia/modelsimage/anguidae_i2',$data);
	}
 ...
 * ************* This id is returning all the data with id request
 */
    public function anguidae_i3($id){
        ...
        $this->load->view('pagefactopedia/modelsimage/anguidae_i3',$data);
	}
 ...
 * ************* This id is returning all the data with id request
 */
    public function anguidae_i4($id){
        ...
        $this->load->view('pagefactopedia/modelsimage/anguidae_i4',$data);
	} 
 ...
 * ************* This id is returning all the data with id request
 */    
    public function anguidaes_do_upload(){ 
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->Anguidaes_model->anguidaes_do_upload();
            $this->Anguidaes_model->anguidaes_do_upload_first();
 ...
 * ************* This id is returning all the data with id request
 */ 
    public function anguidaes_do_upload2(){  
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Anguidaes_model->anguidaes_do_upload();
            $this->Anguidaes_model->anguidaes_do_upload_second();
 ...
 * ************* This id is returning all the data with id request
 */    
    public function anguidaes_do_upload3(){      
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Anguidaes_model->anguidaes_do_upload();
            $this->Anguidaes_model->anguidaes_do_upload_third();
 ...
 * ************* This id is returning all the data with id request
 */ 
    public function anguidaes_do_upload4(){  
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Anguidaes_model->anguidaes_do_upload();
            $this->Anguidaes_model->anguidaes_do_upload_fourth();
