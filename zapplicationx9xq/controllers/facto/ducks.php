...
class Ducks extends CI_Controller {
    ...
    public function __construct()
        {
				...
				$this->model = 'factopedia/Ducks_model';
					// Set the variable for $redirecteur above
				$this->redirecteur = 'facto/Ducks/ducks';
...
/*
 *
 * ************* This is the main page duck' settings 
 *
 */     
    public function ducks(){
         ...
         * ******************** Pagination setting
         */
        $config['base_url']    = base_url(). '/facto/Ducks/ducks';
            // This gets the total row from my ducks' table
        $config['total_rows']  = $this->Ducks_model->record_count();
 ...
 */
    public function duck_e($id){
        ...
        $this->load->model($this->model);
             ...
             */
        $data['lists']        = $this->Ducks_model->get_duck_databases(); 
            // Call the users variable and the table name to output the result
            // Call it everywhere you want to use it 
        $data['users']        = $this->Ducks_model->get_users();
        $data['image']        = $this->Ducks_model->get_my_images($id);

         // Here we are getting the user profile image
        $data['im_prof'] = $this->User_model->get_im_profile();
        $data['spons']        = $this->Buyorsell_model->pets_sponsord();
        $data['sponsf']       = $this->Buyorsell_model->pets_sponsordfoot();
        $data['animal']       = $this->Ducks_model->get_duck_details($id);
        $data['main_content'] = 'pagefactopedia/editorial/duck_e';
            /*
...
/*
 *
 * ************* This is the more page duck' settings 
 * ************* This id is returning all the data with id request
 */
    public function duck_m($id){
        // To simplify thing we are taking the ads or sponsorized items from the buyorsell model 
        $this->load->model($this->buyorsell_model);
        $this->load->helper('text');
        ...
        $data['sponsf']       = $this->Buyorsell_model->pets_sponsordfoot();
        $data['animal']       = $this->Ducks_model->get_duck_details($id);
        $data['main_content'] = 'pagefactopedia/learn/duck_m';
            /*
             * this will iclude the main.php inside layouts
             */
        $this->load->view('layouts/main',$data);
...
/*
 *
 * ************* This is the first image model for the duck's page 
 * ************* This id is returning all the data with id request
 */
    public function duck_i($id){
            // Loads the model
        $this->load->model($this->model);
        ...
        $this->load->view('pagefactopedia/modelsimage/duck_i',$data);
	}
    
/*
 *
 * ************* This is the second image model for the duck's page 
 * ************* This id is returning all the data with id request
 */
    public function duck_i2($id){
            // Loads the model
        $this->load->model($this->model);
        ...
        $this->load->view('pagefactopedia/modelsimage/duck_i2',$data);
	}
    
/*
 *
 * ************* This is the third image model for the duck's page 
 * ************* This id is returning all the data with id request
 */
    public function duck_i3($id){
        ...
        $this->load->view('pagefactopedia/modelsimage/duck_i3',$data);
	}
    
/*
 *
 * ************* This is the fourth image model for the duck's page 
 * ************* This id is returning all the data with id request
 */
    public function duck_i4($id){
        ...
        $this->load->view('pagefactopedia/modelsimage/duck_i4',$data);
	} 
    
/*
 *
 * ************* This is the Update the information in the more page for duck 
 * ************* This id is returning all the data with id request
 */
        // Update the duck factopedia page
...
/*
 *
 * ************* This is the upload the first image in the flexslider on the duck's page 
 * ************* This id is returning all the data with id request
 */   
    public function ducks_do_upload(){ 
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->Ducks_model->ducks_do_upload();
            $this->Ducks_model->ducks_do_upload_first();
...
/*
 *
 * ************* This is the upload the second image in the flexslider on the duck's page 
 * ************* This id is returning all the data with id request
 */ 
    public function ducks_do_upload2(){  
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Ducks_model->ducks_do_upload();
            $this->Ducks_model->ducks_do_upload_second();
...
/*
 *
 * ************* This is the upload the third image in the flexslider on the duck's page 
 * ************* This id is returning all the data with id request
 */    
    public function ducks_do_upload3(){      
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Ducks_model->ducks_do_upload();
            $this->Ducks_model->ducks_do_upload_third();
...
/*
 *
 * ************* This is the upload the fourth image in the flexslider on the duck's page 
 * ************* This id is returning all the data with id request
 */ 
    public function ducks_do_upload4(){  
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Ducks_model->ducks_do_upload();
            $this->Ducks_model->ducks_do_upload_fourth();
