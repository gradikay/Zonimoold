...
class Dibamidaes extends CI_Controller { 
    ...
    public function __construct()
        {
				...
				$this->model = 'factopedia/Dibamidaes_model';
					// Set the variable for $redirecteur above
				$this->redirecteur = 'facto/Dibamidaes/dibamidaes';
 ...
 */    
    public function dibamidaes(){
         ...
         * ******************** Pagination setting
         */
        $config['base_url']    = base_url(). '/facto/Dibamidaes/dibamidaes';
            // This gets the total row from my dogs' table pasted from dog's controller
        $config['total_rows']  = $this->Dibamidaes_model->record_count();
        ...
        $data['results']      = $this->Dibamidaes_model->fetch_dibamidaes($config['per_page'], $page);
        ...
        $data['getAll']       = $this->Dibamidaes_model->return_row_count();
		$data['getEverything']= $this->Count_model->return_all_database_count();
        $data['main_content'] = 'pagefactopedia/dibamidaes';
 ...
 */   
    public function dibamidae_e($id){
        // To simplify thing we are taking the ads or sponsorized items from the buyorsell model 
        $this->load->model($this->buyorsell_model);
        $this->load->helper('text');
        ...
        $this->load->model($this->model);
             ...
             */
        $data['lists']        = $this->Dibamidaes_model->get_dibamidae_databases(); 
            // Call the users variable and the table name to output the result
            // Call it everywhere you want to use it 
        $data['users']        = $this->Dibamidaes_model->get_users();
        $data['image']        = $this->Dibamidaes_model->get_my_images($id);

		$data['im_prof']      = $this->User_model->get_im_profile();
        $data['spons']        = $this->Buyorsell_model->pets_sponsord();
        $data['sponsf']       = $this->Buyorsell_model->pets_sponsordfoot();
        $data['animal']       = $this->Dibamidaes_model->get_dibamidae_details($id);
        $data['main_content'] = 'pagefactopedia/editorial/dibamidae_e';
 ...
 * ************* This id is returning all the data with id request
 */
    public function dibamidae_m($id){
        // To simplify thing we are taking the ads or sponsorized items from the buyorsell model 
        $this->load->model($this->buyorsell_model);
        $this->load->helper('text');
        ...
        $data['sponsf']       = $this->Buyorsell_model->pets_sponsordfoot();
        $data['animal']       = $this->Dibamidaes_model->get_dibamidae_details($id);
        $data['main_content'] = 'pagefactopedia/learn/dibamidae_m';
            /*
             * this will iclude the main.php inside layouts
             */
        $this->load->view('layouts/main',$data);
 ...
 * ************* This id is returning all the data with id request
 */
    public function dibamidae_i($id){
            // Loads the model
        $this->load->model($this->model);
        ...
        $this->load->view('pagefactopedia/modelsimage/dibamidae_i',$data);
	}
 ...
 * ************* This id is returning all the data with id request
 */
    public function dibamidae_i2($id){
            // Loads the model
        $this->load->model($this->model);
        ...
        $this->load->view('pagefactopedia/modelsimage/dibamidae_i2',$data);
	}
 ...
 * ************* This id is returning all the data with id request
 */
    public function dibamidae_i3($id){
        ...
        $this->load->view('pagefactopedia/modelsimage/dibamidae_i3',$data);
	}
 ...
 * ************* This id is returning all the data with id request
 */
    public function dibamidae_i4($id){
        ...
        $this->load->view('pagefactopedia/modelsimage/dibamidae_i4',$data);
	} 
 ...
 * ************* This id is returning all the data with id request
 */    
    public function dibamidaes_do_upload(){ 
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->Dibamidaes_model->dibamidaes_do_upload();
            $this->Dibamidaes_model->dibamidaes_do_upload_first();
 ...
 * ************* This id is returning all the data with id request
 */ 
    public function dibamidaes_do_upload2(){  
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Dibamidaes_model->dibamidaes_do_upload();
            $this->Dibamidaes_model->dibamidaes_do_upload_second();
 ...
 * ************* This id is returning all the data with id request
 */    
    public function dibamidaes_do_upload3(){      
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Dibamidaes_model->dibamidaes_do_upload();
            $this->Dibamidaes_model->dibamidaes_do_upload_third();
 ...
 * ************* This id is returning all the data with id request
 */ 
    public function dibamidaes_do_upload4(){  
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Dibamidaes_model->dibamidaes_do_upload();
            $this->Dibamidaes_model->dibamidaes_do_upload_fourth();
