...
class Cavys extends CI_Controller {
    ...
    public function youport(){
        ...
        redirect('facto/Cavys/cavys');
    }
    
/*
 *
 * ************* This is the main page cavy' settings 
 *
 */   
    public function cavys(){
         ...
         * ******************** Pagination setting
         */
        $config['base_url']    = base_url(). 'facto/Cavys/cavys';
            // This gets the total row from my cavys' table
        $config['total_rows']  = $this->Cavys_model->record_count();
...
/*
 *
 * ************* This is the edit page cavy' settings 
 * ************* This id is returning all the data with id request
 */ 
    public function cavy_e($id){
        // To simplify thing we are taking the ads or sponsorized items from the buyorsell model 
        $this->load->model('Buyorsell_model');
        $this->load->helper('text');
        ...
        $this->load->model('factopedia/Cavys_model');
             ...
             */
        $data['lists']        = $this->Cavys_model->get_cavy_databases(); 
            // Call the users variable and the table name to output the result
            // Call it everywhere you want to use it 
        $data['users']        = $this->Cavys_model->get_users();
        $data['image']        = $this->Cavys_model->get_my_images($id);

        $data['spons']        = $this->Buyorsell_model->pets_sponsord();
        $data['sponsf']       = $this->Buyorsell_model->pets_sponsordfoot();
        $data['animal']       = $this->Cavys_model->get_cavy_details($id);
        $data['main_content'] = 'pagefactopedia/editorial/cavy_e';
            /*
...
/*
 *
 * ************* This is the more page cavy' settings 
 * ************* This id is returning all the data with id request
 */
    public function cavy_m($id){
        // To simplify thing we are taking the ads or sponsorized items from the buyorsell model 
        $this->load->model('Buyorsell_model');
        $this->load->helper('text');
        ...
        $data['sponsf']       = $this->Buyorsell_model->pets_sponsordfoot();
        $data['animal']       = $this->Cavys_model->get_cavy_details($id);
        $data['main_content'] = 'pagefactopedia/learn/cavy_m';
            /*
             * this will iclude the main.php inside layouts
             */
        $this->load->view('layouts/main',$data);
...
/*
 *
 * ************* This is the first image model for the cavy's page 
 * ************* This id is returning all the data with id request
 */
    public function cavy_i($id){
        ...
        $this->load->view('pagefactopedia/modelsimage/cavy_i',$data);
	}
    
/*
 *
 * ************* This is the second image model for the cavy's page 
 * ************* This id is returning all the data with id request
 */
    public function cavy_i2($id){
            // Loads the model
        $this->load->model('factopedia/Cavys_model');
        ...
        $this->load->view('pagefactopedia/modelsimage/cavy_i2',$data);
	}
    

/*
 *
 * ************* This is the third image model for the cavy's page 
 * ************* This id is returning all the data with id request
 */
    public function cavy_i3($id){
        ...
        $this->load->view('pagefactopedia/modelsimage/cavy_i3',$data);
	}
    

/*
 *
 * ************* This is the fourth image model for the cavy's page 
 * ************* This id is returning all the data with id request
 */
    public function cavy_i4($id){
        ...
        $this->load->view('pagefactopedia/modelsimage/cavy_i4',$data);
	} 
    

/*
 *
 * ************* This is the Update the information in the more page for cavy 
 * ************* This id is returning all the data with id request
 */  
...
/*
 *
 * ************* This is the upload the first image in the flexslider on the cavy's page 
 * ************* This id is returning all the data with id request
 */    
    
    public function cavys_do_upload(){ 
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->Cavys_model->cavys_do_upload();
            $this->Cavys_model->cavys_do_upload_first();
...
/*
 *
 * ************* This is the upload the second image in the flexslider on the cavy's page 
 * ************* This id is returning all the data with id request
 */
    public function cavys_do_upload2(){  
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->session->set_flashdata('failed_post','Sorry, Your image could not been uploaded'. $this->upload->display_errors());
                ...
                //redirect('Cavys/cavy_i',$error);
                // PLEASE SET THE REDIRECTION FOR ERROR HANDLING
            redirect('facto/Cavys/error');
           ...
           // Image Title
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Cavys_model->cavys_do_upload();
            $this->Cavys_model->cavys_do_upload_second();
...
/*
 *
 * ************* This is the upload the third image in the flexslider on the cavy's page 
 * ************* This id is returning all the data with id request
 */    
    public function cavys_do_upload3(){      
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Cavys_model->cavys_do_upload();
            $this->Cavys_model->cavys_do_upload_third();
...
/*
 *
 * ************* This is the upload the fourth image in the flexslider on the cavy's page 
 * ************* This id is returning all the data with id request
 */ 
    public function cavys_do_upload4(){  
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Cavys_model->cavys_do_upload();
            $this->Cavys_model->cavys_do_upload_fourth();
