...
class Marsupials extends CI_Controller {
    ...
    public function youport(){
        ...
        redirect('facto/Marsupials/marsupials');
    }
/*
 *
 * ************* This is the main page dog' settings 
 *
 */    
    public function marsupials(){
         ...
         * ******************** Pagination setting
         */
        $config['base_url']    = base_url(). '/facto/Marsupials/marsupials';
            // This gets the total row from my dogs' table
        $config['total_rows']  = $this->Marsupials_model->record_count();
 ...
 */
    public function marsupial_e($id){
        ...
        $this->load->model('factopedia/Marsupials_model');
             ...
             */
        $data['lists']        = $this->Marsupials_model->get_marsupial_databases(); 
            // Call the users variable and the table name to output the result
            // Call it everywhere you want to use it 
        $data['users']        = $this->Marsupials_model->get_users();
        $data['image']        = $this->Marsupials_model->get_my_images($id);

        $data['spons']        = $this->Buyorsell_model->pets_sponsord();
        $data['sponsf']       = $this->Buyorsell_model->pets_sponsordfoot();
        $data['animal']       = $this->Marsupials_model->get_marsupial_details($id);
        $data['main_content'] = 'pagefactopedia/editorial/marsupial_e';
            /*
...
/*
 *
 * ************* This is the more page dog' settings 
 * ************* This id is returning all the data with id request
 */
    public function marsupial_m($id){
        // To simplify thing we are taking the ads or sponsorized items from the buyorsell model 
        $this->load->model('Buyorsell_model');
        $this->load->helper('text');
        ...
        $data['sponsf']       = $this->Buyorsell_model->pets_sponsordfoot();
        $data['animal']       = $this->Marsupials_model->get_marsupial_details($id);
        $data['main_content'] = 'pagefactopedia/learn/marsupial_m';
            /*
             * this will iclude the main.php inside layouts
             */
        $this->load->view('layouts/main',$data);
...
/*
 *
 * ************* This is the first image model for the dog's page 
 * ************* This id is returning all the data with id request
 */
    public function marsupial_i($id){
            // Loads the model
        $this->load->model('factopedia/Marsupials_model');
        ...
        $this->load->view('pagefactopedia/modelsimage/marsupial_i',$data);
	}
    
/*
 *
 * ************* This is the second image model for the dog's page 
 * ************* This id is returning all the data with id request
 */
    public function marsupial_i2($id){
            // Loads the model
        $this->load->model('factopedia/Marsupials_model');
        ...
        $this->load->view('pagefactopedia/modelsimage/marsupial_i2',$data);
	}
    
/*
 *
 * ************* This is the third image model for the dog's page 
 * ************* This id is returning all the data with id request
 */
    public function marsupial_i3($id){
        ...
        $this->load->view('pagefactopedia/modelsimage/marsupial_i3',$data);
	}
    
/*
 *
 * ************* This is the fourth image model for the dog's page 
 * ************* This id is returning all the data with id request
 */
    public function marsupial_i4($id){
        ...
        $this->load->view('pagefactopedia/modelsimage/marsupial_i4',$data);
	} 
    
/*
 *
 * ************* This is the Update the information in the more page for dog 
 * ************* This id is returning all the data with id request
 */
...
/*
 *
 * ************* This is the upload the first image in the flexslider on the dog's page 
 * ************* This id is returning all the data with id request
 */     
    public function marsupials_do_upload(){ 
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->Marsupials_model->marsupials_do_upload();
            $this->Marsupials_model->marsupials_do_upload_first();
...
/*
 *
 * ************* This is the upload the second image in the flexslider on the dog's page 
 * ************* This id is returning all the data with id request
 */
    public function marsupials_do_upload2(){  
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Marsupials_model->marsupials_do_upload();
            $this->Marsupials_model->marsupials_do_upload_second();
...
/*
 *
 * ************* This is the upload the third image in the flexslider on the dog's page 
 * ************* This id is returning all the data with id request
 */    
    public function marsupials_do_upload3(){      
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Marsupials_model->marsupials_do_upload();
            $this->Marsupials_model->marsupials_do_upload_third();
...
/*
 *
 * ************* This is the upload the fourth image in the flexslider on the dog's page 
 * ************* This id is returning all the data with id request
 */ 
    public function marsupials_do_upload4(){  
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Marsupials_model->marsupials_do_upload();
            $this->Marsupials_model->marsupials_do_upload_fourth();
