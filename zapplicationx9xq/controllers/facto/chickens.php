...
class Chickens extends CI_Controller {
    ...
    public function __construct()
        {
				...
				$this->model = 'factopedia/Chickens_model';
					// Set the variable for $redirecteur above
				$this->redirecteur = 'facto/Chickens/chickens';
...
/*
 *
 * ************* This is the main page chicken' settings 
 *
 */     
    public function chickens(){
         ...
         * ******************** Pagination setting
         */
        $config['base_url']    = base_url(). '/facto/Chickens/chickens';
            // This gets the total row from my chickens' table
        $config['total_rows']  = $this->Chickens_model->record_count();
 ...
 */
    public function chicken_e($id){
        ...
        $this->load->model($this->model);
             ...
             */
        $data['lists']        = $this->Chickens_model->get_chicken_databases(); 
            // Call the users variable and the table name to output the result
            // Call it everywhere you want to use it 
        $data['users']        = $this->Chickens_model->get_users();
        $data['image']        = $this->Chickens_model->get_my_images($id);

         // Here we are getting the user profile image
        $data['im_prof'] = $this->User_model->get_im_profile();
        $data['spons']        = $this->Buyorsell_model->pets_sponsord();
        $data['sponsf']       = $this->Buyorsell_model->pets_sponsordfoot();
        $data['animal']       = $this->Chickens_model->get_chicken_details($id);
        $data['main_content'] = 'pagefactopedia/editorial/chicken_e';
            /*
...
/*
 *
 * ************* This is the more page chicken' settings 
 * ************* This id is returning all the data with id request
 */
    public function chicken_m($id){
        // To simplify thing we are taking the ads or sponsorized items from the buyorsell model 
        $this->load->model($this->buyorsell_model);
        $this->load->helper('text');
        ...
        $data['sponsf']       = $this->Buyorsell_model->pets_sponsordfoot();
        $data['animal']       = $this->Chickens_model->get_chicken_details($id);
        $data['main_content'] = 'pagefactopedia/learn/chicken_m';
            /*
             * this will iclude the main.php inside layouts
             */
        $this->load->view('layouts/main',$data);
...
/*
 *
 * ************* This is the first image model for the chicken's page 
 * ************* This id is returning all the data with id request
 */
    public function chicken_i($id){
            // Loads the model
        $this->load->model($this->model);
        ...
        $this->load->view('pagefactopedia/modelsimage/chicken_i',$data);
	}
    
/*
 *
 * ************* This is the second image model for thechicken's page 
 * ************* This id is returning all the data with id request
 */
    public function chicken_i2($id){
            // Loads the model
        $this->load->model($this->model);
        ...
        $this->load->view('pagefactopedia/modelsimage/chicken_i2',$data);
	}
    
/*
 *
 * ************* This is the third image model for the chicken's page 
 * ************* This id is returning all the data with id request
 */
    public function chicken_i3($id){
        ...
        $this->load->view('pagefactopedia/modelsimage/chicken_i3',$data);
	}
    
/*
 *
 * ************* This is the fourth image model for the chicken's page 
 * ************* This id is returning all the data with id request
 */
    public function chicken_i4($id){
        ...
        $this->load->view('pagefactopedia/modelsimage/chicken_i4',$data);
	} 
    
/*
 *
 * ************* This is the Update the information in the more page for chicken 
 * ************* This id is returning all the data with id request
 */
        // Update the chicken factopedia page
     public function fastmha(){          
        ...
        $this->form_validation->set_rules('links','Links','trim|xss_clean');         
		 ...
		 if ($this->form_validation->run() == FALSE){
						...
						// If success redirect to Chickens/chickens.php
					redirect($this->redirecteur);
			
                } else {
                       
						// Upload it the right place by inserting the data in the right id
					$this->Chickens_model->update();
...
/*
 *
 * ************* This is the upload the first image in the flexslider on the chicken's page 
 * ************* This id is returning all the data with id request
 */   
    public function chickens_do_upload(){ 
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->Chickens_model->chickens_do_upload();
            $this->Chickens_model->chickens_do_upload_first();
...
/*
 *
 * ************* This is the upload the second image in the flexslider on the chicken's page 
 * ************* This id is returning all the data with id request
 */ 
    public function chickens_do_upload2(){  
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Chickens_model->chickens_do_upload();
            $this->Chickens_model->chickens_do_upload_second();
...
/*
 *
 * ************* This is the upload the third image in the flexslider on the chicken's page 
 * ************* This id is returning all the data with id request
 */    
    public function chickens_do_upload3(){      
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            //redirect('Chickens/chicken_i',$error);
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Chickens_model->chickens_do_upload();
            $this->Chickens_model->chickens_do_upload_third();
...
/*
 *
 * ************* This is the upload the fourth image in the flexslider on the chicken's page 
 * ************* This id is returning all the data with id request
 */ 
    public function chickens_do_upload4(){  
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Chickens_model->chickens_do_upload();
            $this->Chickens_model->chickens_do_upload_fourth();
