...
class Monotremes extends CI_Controller {
    ...
    public function youport(){
        ...
        redirect('facto/Monotremes/monotremes');
    }
/*
 *
 * ************* This is the main page monotreme' settings 
 *
 */    
    public function monotremes(){
         ...
         * ******************** Pagination setting
         */
        $config['base_url']    = base_url(). '/facto/Monotremes/monotremes';
            // This gets the total row from my dogs' table
        $config['total_rows']  = $this->Monotremes_model->record_count();
        ...
        $data['results']      = $this->Monotremes_model->fetch_monotremes($config['per_page'], $page);
        ...
        $data['getAll']       = $this->Monotremes_model->return_row_count();
		$data['getEverything']= $this->Count_model->return_all_database_count();
        $data['main_content'] = 'pagefactopedia/monotremes';
        $this->load->view('layouts/main',$data);
    }
    
/*
 *
 * ************* This is the edit page monotreme' settings 
 * ************* This id is returning all the data with id request
 */   
    public function monotreme_e($id){
        // To simplify thing we are taking the ads or sponsorized items from the buyorsell model 
        $this->load->model('Buyorsell_model');
        $this->load->helper('text');
        ...
        $this->load->model('factopedia/Monotremes_model');
             ...
             */
        $data['lists']        = $this->Monotremes_model->get_monotreme_databases(); 
            // Call the users variable and the table name to output the result
            // Call it everywhere you want to use it 
        $data['users']        = $this->Monotremes_model->get_users();
        $data['image']        = $this->Monotremes_model->get_my_images($id);

        $data['spons']        = $this->Buyorsell_model->pets_sponsord();
        $data['sponsf']       = $this->Buyorsell_model->pets_sponsordfoot();
        $data['animal']       = $this->Monotremes_model->get_monotreme_details($id);
        $data['main_content'] = 'pagefactopedia/editorial/monotreme_e';
...
/*
 *
 * ************* This is the more page monotreme' settings 
 * ************* This id is returning all the data with id request
 */
    public function monotreme_m($id){
        // To simplify thing we are taking the ads or sponsorized items from the buyorsell model 
        $this->load->model('Buyorsell_model');
        $this->load->helper('text');
        ...
        $data['sponsf']       = $this->Buyorsell_model->pets_sponsordfoot();
        $data['animal']       = $this->Monotremes_model->get_monotreme_details($id);
        $data['main_content'] = 'pagefactopedia/learn/monotreme_m';
            /*
             * this will iclude the main.php inside layouts
             */
        $this->load->view('layouts/main',$data);
...
/*
 *
 * ************* This is the first image model for the monotreme's page 
 * ************* This id is returning all the data with id request
 */
    public function monotreme_i($id){
            // Loads the model
        $this->load->model('factopedia/Monotremes_model');
        ...
        $this->load->view('pagefactopedia/modelsimage/monotreme_i',$data);
	}
    
/*
 *
 * ************* This is the second image model for the monotreme's page 
 * ************* This id is returning all the data with id request
 */
    public function monotreme_i2($id){
            // Loads the model
        $this->load->model('factopedia/Monotremes_model');
        ...
        $this->load->view('pagefactopedia/modelsimage/monotreme_i2',$data);
	}
    
/*
 *
 * ************* This is the third image model for the monotreme's page 
 * ************* This id is returning all the data with id request
 */
    public function monotreme_i3($id){
        ...
        $this->load->view('pagefactopedia/modelsimage/monotreme_i3',$data);
	}
    
/*
 *
 * ************* This is the fourth image model for the monotreme's page 
 * ************* This id is returning all the data with id request
 */
    public function monotreme_i4($id){
        ...
        $this->load->view('pagefactopedia/modelsimage/monotreme_i4',$data);
	} 
    
/*
 *
 * ************* This is the Update the information in the more page for monotreme 
 * ************* This id is returning all the data with id request
 */
     public function fastmha(){          
        ...
        $this->Monotremes_model->update($id);
         
         $this->session->set_flashdata('failed_success','Thank you for updating factopedia. Your contribution is highly appreciate');
         
            // If success redirect to Monotremes/monotremes.php
        redirect('facto/Monotremes/monotremes');
            
     }
/*
 *
 * ************* This is the upload the first image in the flexslider on the monotreme's page 
 * ************* This id is returning all the data with id request
 */    
    public function monotremes_do_upload(){ 
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->Monotremes_model->monotremes_do_upload();
            $this->Monotremes_model->monotremes_do_upload_first();
...
/*
 *
 * ************* This is the upload the second image in the flexslider on the monotreme's page 
 * ************* This id is returning all the data with id request
 */ 
    public function monotremes_do_upload2(){  
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Monotremes_model->monotremes_do_upload();
            $this->Monotremes_model->monotremes_do_upload_second();
...
/*
 *
 * ************* This is the upload the third image in the flexslider on the monotreme's page 
 * ************* This id is returning all the data with id request
 */    
    public function monotremes_do_upload3(){      
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Monotremes_model->monotremes_do_upload();
            $this->Monotremes_model->monotremes_do_upload_third();
...
/*
 *
 * ************* This is the upload the fourth image in the flexslider on the monotreme's page 
 * ************* This id is returning all the data with id request
 */ 
    public function monotremes_do_upload4(){  
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Monotremes_model->monotremes_do_upload();
            $this->Monotremes_model->monotremes_do_upload_fourth();
