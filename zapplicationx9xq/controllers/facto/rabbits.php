...
class Rabbits extends CI_Controller {
    ...
    public function youport(){
        ...
        redirect('facto/Rabbits/rabbits');
    }
/*
 *
 * ************* This is the main page rabbit' settings 
 *
 */    
    public function rabbits(){
         ...
         * ******************** Pagination setting
         */
        $config['base_url']    = base_url(). '/facto/Rabbits/rabbits';
            // This gets the total row from my rabbits' table
        $config['total_rows']  = $this->Rabbits_model->record_count();
 ...
 */
    public function rabbit_e($id){
        ...
        $this->load->model('factopedia/Rabbits_model');
             ...
             */
        $data['lists']        = $this->Rabbits_model->get_rabbit_databases(); 
            // Call the users variable and the table name to output the result
            // Call it everywhere you want to use it 
        $data['users']        = $this->Rabbits_model->get_users();
        $data['image']        = $this->Rabbits_model->get_my_images($id);

        $data['spons']        = $this->Buyorsell_model->pets_sponsord();
        $data['sponsf']       = $this->Buyorsell_model->pets_sponsordfoot();
        $data['animal']       = $this->Rabbits_model->get_rabbit_details($id);
        $data['main_content'] = 'pagefactopedia/editorial/rabbit_e';
            /*
...
/*
 *
 * ************* This is the more page rabbit' settings 
 * ************* This id is returning all the data with id request
 */
    public function rabbit_m($id){
        // To simplify thing we are taking the ads or sponsorized items from the buyorsell model 
        $this->load->model('Buyorsell_model');
        $this->load->helper('text');
        ...
        $data['sponsf']       = $this->Buyorsell_model->pets_sponsordfoot();
        $data['animal']       = $this->Rabbits_model->get_rabbit_details($id);
        $data['main_content'] = 'pagefactopedia/learn/rabbit_m';
            /*
             * this will iclude the main.php inside layouts
             */
        $this->load->view('layouts/main',$data);
...
/*
 *
 * ************* This is the first image model for the rabbit's page 
 * ************* This id is returning all the data with id request
 */
    public function rabbit_i($id){
            // Loads the model
        $this->load->model('factopedia/Rabbits_model');
        ...
        $this->load->view('pagefactopedia/modelsimage/rabbit_i',$data);
	}
    
/*
 *
 * ************* This is the second image model for the rabbit's page 
 * ************* This id is returning all the data with id request
 */
    public function rabbit_i2($id){
            // Loads the model
        $this->load->model('factopedia/Rabbits_model');
        ...
        $this->load->view('pagefactopedia/modelsimage/rabbit_i2',$data);
	}
    
/*
 *
 * ************* This is the third image model for the rabbit's page 
 * ************* This id is returning all the data with id request
 */
    public function rabbit_i3($id){
        ...
        $this->load->view('pagefactopedia/modelsimage/rabbit_i3',$data);
	}
    
/*
 *
 * ************* This is the fourth image model for the rabbit's page 
 * ************* This id is returning all the data with id request
 */
    public function rabbit_i4($id){
        ...
        $this->load->view('pagefactopedia/modelsimage/rabbit_i4',$data);
	} 
    
/*
 *
 * ************* This is the Update the information in the more page for rabbit 
 * ************* This id is returning all the data with id request
 */
     public function fastmha(){          
        ...
        $this->load->model('factopedia/Rabbits_model');
            ...
            //Validation Rules 
            // Animal name  not sure if this is on use
        ...
        $this->form_validation->set_rules('yaZoFKzEio','Height','trim|xss_clean|max_length[2]');
            // Animal coat 
        $this->form_validation->set_rules('nkTdZQcYAo','coat','trim|xss_clean');
            // Animal other name
        ...
        $this->Rabbits_model->update($id);
         
         $this->session->set_flashdata('failed_success','Thank you for updating factopedia. Your contribution is highly appreciate');
         
            // If success redirect to Rabbits/rabbits.php
        redirect('facto/Rabbits/rabbits');
            
     }
/*
 *
 * ************* This is the upload the first image in the flexslider on the rabbit's page 
 * ************* This id is returning all the data with id request
 */    
    public function rabbits_do_upload(){ 
		...
		if ( ! $this->upload->do_upload())
		{
           ...
           // Image Title
            ...
            $this->Rabbits_model->rabbits_do_upload();
            $this->Rabbits_model->rabbits_do_upload_first();
...
/*
 *
 * ************* This is the upload the second image in the flexslider on the rabbit's page 
 * ************* This id is returning all the data with id request
 */ 
    public function rabbits_do_upload2(){  
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Rabbits_model->rabbits_do_upload();
            $this->Rabbits_model->rabbits_do_upload_second();
...
/*
 *
 * ************* This is the upload the third image in the flexslider on the rabbit's page 
 * ************* This id is returning all the data with id request
 */    
    public function rabbits_do_upload3(){      
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Rabbits_model->rabbits_do_upload();
            $this->Rabbits_model->rabbits_do_upload_third();
...
/*
 *
 * ************* This is the upload the fourth image in the flexslider on the rabbit's page 
 * ************* This id is returning all the data with id request
 */ 
    public function rabbits_do_upload4(){  
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Rabbits_model->rabbits_do_upload();
            $this->Rabbits_model->rabbits_do_upload_fourth();
