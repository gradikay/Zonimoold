...
class Primates extends CI_Controller { 
    ...
    public function __construct()
        {
				...
				$this->model = 'factopedia/Primates_model';
					// Set the variable for $redirecteur above
				$this->redirecteur = 'facto/Primates/primates';
...
/*
 *
 * ************* This is the main page primate' settings 
 *
 */    
    public function primates(){
         ...
         * ******************** Pagination setting
         */
        $config['base_url']    = base_url(). '/facto/Primates/primates';
            // This gets the total row from my dogs' table pasted from primate's controller
        $config['total_rows']  = $this->Primates_model->record_count();
        ...
        $data['results']      = $this->Primates_model->fetch_primates($config['per_page'], $page);
        ...
        $data['getAll']       = $this->Primates_model->return_row_count();
		$data['getEverything']= $this->Count_model->return_all_database_count();
        $data['main_content'] = 'pagefactopedia/primates';
        $this->load->view('layouts/main',$data);
    }
    
/*
 *
 * ************* This is the edit page primate' settings 
 * ************* This id is returning all the data with id request
 */   
    public function primate_e($id){
        // To simplify thing we are taking the ads or sponsorized items from the buyorsell model 
        $this->load->model($this->buyorsell_model);
        $this->load->helper('text');
        ...
        $this->load->model($this->model);
             ...
             */
        $data['lists']        = $this->Primates_model->get_primate_databases(); 
            // Call the users variable and the table name to output the result
            // Call it everywhere you want to use it 
        $data['users']        = $this->Primates_model->get_users();
        $data['image']        = $this->Primates_model->get_my_images($id);

		$data['im_prof']      = $this->User_model->get_im_profile();
        $data['spons']        = $this->Buyorsell_model->pets_sponsord();
        $data['sponsf']       = $this->Buyorsell_model->pets_sponsordfoot();
        $data['animal']       = $this->Primates_model->get_primate_details($id);
        $data['main_content'] = 'pagefactopedia/editorial/primate_e';
...
/*
 *
 * ************* This is the more page primate' settings 
 * ************* This id is returning all the data with id request
 */
    public function primate_m($id){
        // To simplify thing we are taking the ads or sponsorized items from the buyorsell model 
        $this->load->model($this->buyorsell_model);
        $this->load->helper('text');
        ...
        $data['sponsf']       = $this->Buyorsell_model->pets_sponsordfoot();
        $data['animal']       = $this->Primates_model->get_primate_details($id);
        $data['main_content'] = 'pagefactopedia/learn/primate_m';
            /*
             * this will iclude the main.php inside layouts
             */
        $this->load->view('layouts/main',$data);
...
/*
 *
 * ************* This is the first image model for the primate's page 
 * ************* This id is returning all the data with id request
 */
    public function primate_i($id){
            // Loads the model
        $this->load->model($this->model);
        ...
        $this->load->view('pagefactopedia/modelsimage/primate_i',$data);
	}
    
/*
 *
 * ************* This is the second image model for the primate's page 
 * ************* This id is returning all the data with id request
 */
    public function primate_i2($id){
            // Loads the model
        $this->load->model($this->model);
        ...
        $this->load->view('pagefactopedia/modelsimage/primate_i2',$data);
	}
    
/*
 *
 * ************* This is the third image model for the primate's page 
 * ************* This id is returning all the data with id request
 */
    public function primate_i3($id){
        ...
        $this->load->view('pagefactopedia/modelsimage/primate_i3',$data);
	}
    
/*
 *
 * ************* This is the fourth image model for the primate's page 
 * ************* This id is returning all the data with id request
 */
    public function primate_i4($id){
        ...
        $this->load->view('pagefactopedia/modelsimage/primate_i4',$data);
	} 
    
/*
 *
 * ************* This is the Update the information in the more page for primate
 * ************* This id is returning all the data with id request
 */
     public function fastmha(){          
        ...
        $this->Primates_model->update($id);
         
         $this->session->set_flashdata('failed_success','Thank you for updating factopedia. Your contribution is highly appreciate');
         
            // If success redirect to Primates/primates.php
        redirect($this->redirecteur);
            
     }
/*
 *
 * ************* This is the upload the first image in the flexslider on the primate's page 
 * ************* This id is returning all the data with id request
 */    
    public function primates_do_upload(){ 
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->Primates_model->primates_do_upload();
            $this->Primates_model->primates_do_upload_first();
...
/*
 *
 * ************* This is the upload the second image in the flexslider on the primate's page 
 * ************* This id is returning all the data with id request
 */ 
    public function primates_do_upload2(){  
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Primates_model->primates_do_upload();
            $this->Primates_model->primates_do_upload_second();
...
/*
 *
 * ************* This is the upload the third image in the flexslider on the primate's page 
 * ************* This id is returning all the data with id request
 */    
    public function primates_do_upload3(){      
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Primates_model->primates_do_upload();
            $this->Primates_model->primates_do_upload_third();
...
/*
 *
 * ************* This is the upload the fourth image in the flexslider on the primate's page 
 * ************* This id is returning all the data with id request
 */ 
    public function primates_do_upload4(){  
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Primates_model->primates_do_upload();
            $this->Primates_model->primates_do_upload_fourth();
