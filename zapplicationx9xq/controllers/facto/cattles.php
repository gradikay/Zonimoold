    ...
    public function __construct()
        {
				...
				$this->model = 'factopedia/Cattles_model';
					// Set the variable for $redirecteur above
				$this->redirecteur = 'facto/Cattles/cattles';				
...
/*
 *
 * ************* This is the main page cattle' settings 
 *
 */     
    public function cattles(){
         ...
         * ******************** Pagination setting
         */
        $config['base_url']    = base_url(). '/facto/Cattles/cattles';
            // This gets the total row from my cattles' table
        $config['total_rows']  = $this->Cattles_model->record_count();
 ...
 */
    public function cattle_e($id){
        ...
        $this->load->model($this->model);
             ...
             */
        $data['lists']        = $this->Cattles_model->get_cattle_databases(); 
            // Call the users variable and the table name to output the result
            // Call it everywhere you want to use it 
        $data['users']        = $this->Cattles_model->get_users();
        $data['image']        = $this->Cattles_model->get_my_images($id);

         // Here we are getting the user profile image
        $data['im_prof']      = $this->User_model->get_im_profile();
        $data['spons']        = $this->Buyorsell_model->pets_sponsord();
        $data['sponsf']       = $this->Buyorsell_model->pets_sponsordfoot();
        $data['animal']       = $this->Cattles_model->get_cattle_details($id);
        $data['main_content'] = 'pagefactopedia/editorial/cattle_e';
            /*
...
/*
 *
 * ************* This is the more page cattle' settings 
 * ************* This id is returning all the data with id request
 */
    public function cattle_m($id){
        // To simplify thing we are taking the ads or sponsorized items from the buyorsell model 
        $this->load->model($this->buyorsell_model);
        $this->load->helper('text');
        ...
        $data['sponsf']       = $this->Buyorsell_model->pets_sponsordfoot();
        $data['animal']       = $this->Cattles_model->get_cattle_details($id);
        $data['main_content'] = 'pagefactopedia/learn/cattle_m';
            /*
             * this will iclude the main.php inside layouts
             */
        $this->load->view('layouts/main',$data);
...
/*
 *
 * ************* This is the first image model for the cattle's page 
 * ************* This id is returning all the data with id request
 */
    public function cattle_i($id){
            // Loads the model
        $this->load->model($this->model);
        ...
        $this->load->view('pagefactopedia/modelsimage/cattle_i',$data);
	}
    
/*
 *
 * ************* This is the second image model for the cattle's page 
 * ************* This id is returning all the data with id request
 */
    public function cattle_i2($id){
            // Loads the model
        $this->load->model($this->model);
        ...
        $this->load->view('pagefactopedia/modelsimage/cattle_i2',$data);
	}
    
/*
 *
 * ************* This is the third image model for the cattle's page 
 * ************* This id is returning all the data with id request
 */
    public function cattle_i3($id){
        ...
        $this->load->view('pagefactopedia/modelsimage/cattle_i3',$data);
	}
    
/*
 *
 * ************* This is the fourth image model for the cattle's page 
 * ************* This id is returning all the data with id request
 */
    public function cattle_i4($id){
        ...
        $this->load->view('pagefactopedia/modelsimage/cattle_i4',$data);
	} 
    
/*
 *
 * ************* This is the Update the information in the more page for cattle 
 * ************* This id is returning all the data with id request
 */
        // Update the cattle factopedia page
...
/*
 *
 * ************* This is the upload the first image in the flexslider on thecattle's page 
 * ************* This id is returning all the data with id request
 */   
    public function cattles_do_upload(){ 
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->Cattles_model->cattles_do_upload();
            $this->Cattles_model->cattles_do_upload_first();
...
/*
 *
 * ************* This is the upload the second image in the flexslider on the cattle's page 
 * ************* This id is returning all the data with id request
 */ 
    public function cattles_do_upload2(){  
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Cattles_model->cattles_do_upload();
            $this->Cattles_model->cattles_do_upload_second();
...
/*
 *
 * ************* This is the upload the third image in the flexslider on the cattle's page 
 * ************* This id is returning all the data with id request
 */    
    public function cattles_do_upload3(){      
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Cattles_model->cattles_do_upload();
            $this->Cattles_model->cattles_do_upload_third();
...
/*
 *
 * ************* This is the upload the fourth image in the flexslider on the cattle's page 
 * ************* This id is returning all the data with id request
 */ 
    public function cattles_do_upload4(){  
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Cattles_model->cattles_do_upload();
            $this->Cattles_model->cattles_do_upload_fourth();
