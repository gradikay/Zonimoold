    ...
    public function __construct()
        {
				...
				$this->model = 'factopedia/Horses_model';
					// Set the variable for $redirecteur above
				$this->redirecteur = 'facto/Horses/horses';
...
/*
 *
 * ************* This is the main page horse' settings 
 *
 */     
    public function horses(){
         ...
         * ******************** Pagination setting
         */
        $config['base_url']    = base_url(). '/facto/Horses/horses';
            // This gets the total row from my horses' table
        $config['total_rows']  = $this->Horses_model->record_count();
        ...
        $data['results']      = $this->Horses_model->fetch_horses($config['per_page'], $page);
        ...
        $data['getAll']       = $this->Horses_model->return_row_count();
		$data['getEverything']= $this->Count_model->return_all_database_count();
        $data['main_content'] = 'pagefactopedia/horses';
        $this->load->view('layouts/main',$data);
    }
    
/*
 *
 * ************* This is the edit page horse' settings 
 * ************* This id is returning all the data with id request
 */
    public function horse_e($id){
        // To simplify thing we are taking the ads or sponsorized items from the buyorsell model 
        $this->load->model($this->buyorsell_model);
        $this->load->helper('text');
        ...
        $this->load->model($this->model);
             ...
             */
        $data['lists']        = $this->Horses_model->get_horse_databases(); 
            // Call the users variable and the table name to output the result
            // Call it everywhere you want to use it 
        $data['users']        = $this->Horses_model->get_users();
        $data['image']        = $this->Horses_model->get_my_images($id);

         // Here we are getting the user profile image
        $data['im_prof'] = $this->User_model->get_im_profile();
        $data['spons']        = $this->Buyorsell_model->pets_sponsord();
        $data['sponsf']       = $this->Buyorsell_model->pets_sponsordfoot();
        $data['animal']       = $this->Horses_model->get_horse_details($id);
        $data['main_content'] = 'pagefactopedia/editorial/horse_e';
            /*
...
/*
 *
 * ************* This is the more page horse' settings 
 * ************* This id is returning all the data with id request
 */
    public function horse_m($id){
        // To simplify thing we are taking the ads or sponsorized items from the buyorsell model 
        $this->load->model($this->buyorsell_model);
        $this->load->helper('text');
        ...
        $data['sponsf']       = $this->Buyorsell_model->pets_sponsordfoot();
        $data['animal']       = $this->Horses_model->get_horse_details($id);
        $data['main_content'] = 'pagefactopedia/learn/horse_m';
            /*
             * this will iclude the main.php inside layouts
             */
        $this->load->view('layouts/main',$data);
...
/*
 *
 * ************* This is the first image model for the horse's page 
 * ************* This id is returning all the data with id request
 */
    public function horse_i($id){
            // Loads the model
        $this->load->model($this->model);
        ...
        $this->load->view('pagefactopedia/modelsimage/horse_i',$data);
	}
    
/*
 *
 * ************* This is the second image model for the horse's page 
 * ************* This id is returning all the data with id request
 */
    public function horse_i2($id){
            // Loads the model
        $this->load->model($this->model);
        ...
        $this->load->view('pagefactopedia/modelsimage/horse_i2',$data);
	}
    
/*
 *
 * ************* This is the third image model for the horse's page 
 * ************* This id is returning all the data with id request
 */
    public function horse_i3($id){
        ...
        $this->load->view('pagefactopedia/modelsimage/horse_i3',$data);
	}
    
/*
 *
 * ************* This is the fourth image model for the horse's page 
 * ************* This id is returning all the data with id request
 */
    public function horse_i4($id){
        ...
        $this->load->view('pagefactopedia/modelsimage/horse_i4',$data);
	} 
    
/*
 *
 * ************* This is the Update the information in the more page for horse 
 * ************* This id is returning all the data with id request
 */
        // Update the horse factopedia page
     public function fastmha(){          
        ...
        $this->form_validation->set_rules('links','Links','trim|xss_clean');         
		 ...
		 if ($this->form_validation->run() == FALSE){
						...
						// If success redirect to Horses/horses.php
					redirect($this->redirecteur);
			
                } else {
                       
						// Upload it the right place by inserting the data in the right id
					$this->Horses_model->update();
...
/*
 *
 * ************* This is the upload the first image in the flexslider on the horse's page 
 * ************* This id is returning all the data with id request
 */   
    public function horses_do_upload(){ 
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->Horses_model->horses_do_upload();
            $this->Horses_model->horses_do_upload_first();
...
/*
 *
 * ************* This is the upload the second image in the flexslider on the horse's page 
 * ************* This id is returning all the data with id request
 */ 
    public function horses_do_upload2(){  
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Horses_model->horses_do_upload();
            $this->Horses_model->horses_do_upload_second();
...
/*
 *
 * ************* This is the upload the third image in the flexslider on the horse's page 
 * ************* This id is returning all the data with id request
 */    
    public function horses_do_upload3(){      
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Horses_model->horses_do_upload();
            $this->Horses_model->horses_do_upload_third();
...
/*
 *
 * ************* This is the upload the fourth image in the flexslider on the horse's page 
 * ************* This id is returning all the data with id request
 */ 
    public function horses_do_upload4(){  
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Horses_model->horses_do_upload();
            $this->Horses_model->horses_do_upload_fourth();
