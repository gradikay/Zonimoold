...
class Cats extends CI_Controller {
    ...
    public function youport(){
        ...
        redirect('facto/Cats/cats');
    }
    
/*
 *
 * ************* This is the main page cat' settings 
 *
 */    
    public function cats(){
         ...
         * ******************** Pagination setting
         */
        $config['base_url']    = base_url(). '/facto/Cats/cats';
        ...
        $data['main_content'] = 'pagefactopedia/cats';
        $this->load->view('layouts/main',$data);
    }

/*
 *
 * ************* This is the edit page cat' settings 
 * ************* This id is returning all the data with id request
 */     
    
    public function cat_e($id){
        // To simplify thing we are taking the ads or sponsorized items from the buyorsell model 
        $this->load->model('Buyorsell_model');
        $this->load->helper('text');
        ...
        $this->load->model('factopedia/Cats_model');
             ...
             */
        $data['lists']        = $this->Cats_model->get_cat_databases(); 
            // Call the users variable and the table name to output the result
            // Call it everywhere you want to use it 
        $data['users']        = $this->Cats_model->get_users();
        $data['image']        = $this->Cats_model->get_my_images($id);

        $data['spons']        = $this->Buyorsell_model->pets_sponsord();
        $data['sponsf']       = $this->Buyorsell_model->pets_sponsordfoot();
        $data['animal']       = $this->Cats_model->get_cat_details($id);
        $data['main_content'] = 'pagefactopedia/editorial/cat_e';
            /*
...
/*
 *
 * ************* This is the more page cat' settings 
 * ************* This id is returning all the data with id request
 */
    public function cat_m($id){
        // To simplify thing we are taking the ads or sponsorized items from the buyorsell model 
        $this->load->model('Buyorsell_model');
        $this->load->helper('text');
        ...
        $data['sponsf']       = $this->Buyorsell_model->pets_sponsordfoot();
        $data['animal']       = $this->Cats_model->get_cat_details($id);
        $data['main_content'] = 'pagefactopedia/learn/cat_m';
            /*
             * this will iclude the main.php inside layouts
             */
        $this->load->view('layouts/main',$data);
...
/*
 *
 * ************* This is the first image model for the cat's page 
 * ************* This id is returning all the data with id request
 */
    public function cat_i($id){
        ...
        $this->load->view('pagefactopedia/modelsimage/cat_i',$data);
	}
    
/*
 *
 * ************* This is the second image model for the cat's page 
 * ************* This id is returning all the data with id request
 */
    public function cat_i2($id){
            // Loads the model
        $this->load->model('factopedia/Cats_model');
        ...
        $this->load->view('pagefactopedia/modelsimage/cat_i2',$data);
	}
    
/*
 *
 * ************* This is the third image model for the cat's page 
 * ************* This id is returning all the data with id request
 */
    public function cat_i3($id){
        ...
        $this->load->view('pagefactopedia/modelsimage/cat_i3',$data);
	}
    
/*
 *
 * ************* This is the fourth image model for the cat's page 
 * ************* This id is returning all the data with id request
 */
    public function cat_i4($id){
        ...
        $this->load->view('pagefactopedia/modelsimage/cat_i4',$data);
	} 
    
/*
 *
 * ************* This is the Update the information in the more page for cat 
 * ************* This id is returning all the data with id request
 */
     public function fastmha(){          
        ...
        $this->Cats_model->update($id);
         ...
         $this->session->set_flashdata('failed_success','Thank you for updating factopedia. Your contribution is highly appreciate');
            ...
            // If success redirect to Cats/cats.php
        redirect('facto/Cats/cats');
            
     }
/*
 *
 * ************* This is the upload the first image in the flexslider on the cat's page 
 * ************* This id is returning all the data with id request
 */    
    public function cats_do_upload(){ 
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->Cats_model->cats_do_upload();
            $this->Cats_model->cats_do_upload_first();
...
/*
 *
 * ************* This is the upload the second image in the flexslider on the cat's page 
 * ************* This id is returning all the data with id request
 */  
    public function cats_do_upload2(){  
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Cats_model->cats_do_upload();
            $this->Cats_model->cats_do_upload_second();
...
/*
 *
 * ************* This is the upload the third image in the flexslider on the cat's page 
 * ************* This id is returning all the data with id request
 */     
    public function cats_do_upload3(){      
		...
		if ( ! $this->upload->do_upload())
		{
           ...
           // Image Title
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Cats_model->cats_do_upload();
            $this->Cats_model->cats_do_upload_third();
...
/*
 *
 * ************* This is the upload the fourth image in the flexslider on the cat's page 
 * ************* This id is returning all the data with id request
 */ 
    public function cats_do_upload4(){  
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Cats_model->cats_do_upload();
            $this->Cats_model->cats_do_upload_fourth();
