...
class Crocodiles extends CI_Controller {
    ...
    public function youport(){
		...
		// This where our function is defined in the Cats' model
...
/*
 *
 * ************* This is the main page crocodile' settings 
 *
 */     
    public function crocodiles(){
         ...
         * ******************** Pagination setting
         */
        $config['base_url']    = base_url(). '/facto/Crocodiles/crocodiles';
            // This gets the total row from my crocodiles' table
        $config['total_rows']  = $this->Crocodiles_model->record_count();
 ...
 */
    public function crocodile_e($id){
        ...
        $this->load->model($this->model);
             ...
             */
        $data['lists']        = $this->Crocodiles_model->get_crocodile_databases(); 
            // Call the users variable and the table name to output the result
            // Call it everywhere you want to use it 
        $data['users']        = $this->Crocodiles_model->get_users();
        $data['image']        = $this->Crocodiles_model->get_my_images($id);

         // Here we are getting the user profile image
        $data['im_prof'] = $this->User_model->get_im_profile();
        $data['spons']        = $this->Buyorsell_model->pets_sponsord();
        $data['sponsf']       = $this->Buyorsell_model->pets_sponsordfoot();
        $data['animal']       = $this->Crocodiles_model->get_crocodile_details($id);
        $data['main_content'] = 'pagefactopedia/editorial/crocodile_e';
            /*
...
/*
 *
 * ************* This is the more page crocodile' settings 
 * ************* This id is returning all the data with id request
 */
    public function crocodile_m($id){
        // To simplify thing we are taking the ads or sponsorized items from the buyorsell model 
        $this->load->model($this->buyorsell_model);
        $this->load->helper('text');
        ...
        $data['sponsf']       = $this->Buyorsell_model->pets_sponsordfoot();
        $data['animal']       = $this->Crocodiles_model->get_crocodile_details($id);
        $data['main_content'] = 'pagefactopedia/learn/crocodile_m';
            /*
             * this will iclude the main.php inside layouts
             */
        $this->load->view('layouts/main',$data);
...
/*
 *
 * ************* This is the first image model for the crocodile's page 
 * ************* This id is returning all the data with id request
 */
    public function crocodile_i($id){
            // Loads the model
        $this->load->model($this->model);
        ...
        $this->load->view('pagefactopedia/modelsimage/crocodile_i',$data);
	}
    
/*
 *
 * ************* This is the second image model for the crocodile's page 
 * ************* This id is returning all the data with id request
 */
    public function crocodile_i2($id){
            // Loads the model
        $this->load->model($this->model);
        ...
        $this->load->view('pagefactopedia/modelsimage/crocodile_i2',$data);
	}
    
/*
 *
 * ************* This is the third image model for the crocodile's page 
 * ************* This id is returning all the data with id request
 */
    public function crocodile_i3($id){
        ...
        $this->load->view('pagefactopedia/modelsimage/crocodile_i3',$data);
	}
    
/*
 *
 * ************* This is the fourth image model for the crocodile's page 
 * ************* This id is returning all the data with id request
 */
    public function crocodile_i4($id){
        ...
        $this->load->view('pagefactopedia/modelsimage/crocodile_i4',$data);
	} 
    
/*
 *
 * ************* This is the Update the information in the more page for crocodile 
 * ************* This id is returning all the data with id request
 */
        // Update the crocodile factopedia page
     public function fastmha(){          
        ...
        $this->form_validation->set_rules('links','Links','trim|xss_clean');           
		 ...
		 if ($this->form_validation->run() == FALSE){
						...
						// If success redirect to crocodiles/crocodiles.php
					redirect($this->redirecteur);
			
                } else {
                       
						// Upload it the right place by inserting the data in the right id
					$this->Crocodiles_model->update();
...
/*
 *
 * ************* This is the upload the first image in the flexslider on the crocodile's page 
 * ************* This id is returning all the data with id request
 */   
    public function crocodiles_do_upload(){ 
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->Crocodiles_model->crocodiles_do_upload();
            $this->Crocodiles_model->crocodiles_do_upload_first();
...
/*
 *
 * ************* This is the upload the second image in the flexslider on the crocodile's page 
 * ************* This id is returning all the data with id request
 */ 
    public function crocodiles_do_upload2(){  
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Crocodiles_model->crocodiles_do_upload();
            $this->Crocodiles_model->crocodiles_do_upload_second();
...
/*
 *
 * ************* This is the upload the third image in the flexslider on the crocodile's page 
 * ************* This id is returning all the data with id request
 */    
    public function crocodiles_do_upload3(){      
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            //redirect('crocodiles/crocodile_i',$error);
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Crocodiles_model->crocodiles_do_upload();
            $this->Crocodiles_model->crocodiles_do_upload_third();
...
/*
 *
 * ************* This is the upload the fourth image in the flexslider on the crocodile's page 
 * ************* This id is returning all the data with id request
 */ 
    public function crocodiles_do_upload4(){  
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Crocodiles_model->crocodiles_do_upload();
            $this->Crocodiles_model->crocodiles_do_upload_fourth();
