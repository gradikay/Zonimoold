    ...
    public function __construct()
        {
				...
				$this->model = 'factopedia/Dogs_model';
					// Set the variable for $redirecteur above
				$this->redirecteur = 'facto/Dogs/dogs';
 ...
 */     
    public function dogs(){
         ...
         * ******************** Pagination setting
         */
        $config['base_url']    = base_url(). '/facto/Dogs/dogs';
            // This gets the total row from my dogs' table
        $config['total_rows']  = $this->Dogs_model->record_count();
        ...
        $data['results']      = $this->Dogs_model->fetch_dogs($config['per_page'], $page);
        ...
        $data['getAll']       = $this->Dogs_model->return_row_count();
		
		$data['getEverything']= $this->Count_model->return_all_database_count();
        $data['main_content'] = 'pagefactopedia/dogs';
 ...
 */
    public function dog_e($id){
        ...
        $this->load->model($this->model);
             ...
             */
        $data['lists']        = $this->Dogs_model->get_dog_databases(); 
            // Call the users variable and the table name to output the result
            // Call it everywhere you want to use it 
        $data['users']        = $this->Dogs_model->get_users();
        $data['image']        = $this->Dogs_model->get_my_images($id);

         // Here we are getting the user profile image
        $data['im_prof'] = $this->User_model->get_im_profile();
        $data['spons']        = $this->Buyorsell_model->pets_sponsord();
        $data['sponsf']       = $this->Buyorsell_model->pets_sponsordfoot();
        $data['animal']       = $this->Dogs_model->get_dog_details($id);
        $data['main_content'] = 'pagefactopedia/editorial/dog_e';
            /*
 ...
 */
    public function dog_m($id){
        ...
        $data['sponsf']       = $this->Buyorsell_model->pets_sponsordfoot();
        $data['animal']       = $this->Dogs_model->get_dog_details($id);
        $data['main_content'] = 'pagefactopedia/learn/dog_m';
            /*
             * this will iclude the main.php inside layouts
             */
        $this->load->view('layouts/main',$data);
 ...
 */
    public function dog_i($id){
        ...
        $this->load->view('pagefactopedia/modelsimage/dog_i',$data);
	}
 ...
 */
    public function dog_i2($id){
        ...
        $this->load->view('pagefactopedia/modelsimage/dog_i2',$data);
	}
 ...
 */
    public function dog_i3($id){
        ...
        $this->load->view('pagefactopedia/modelsimage/dog_i3',$data);
	}
 ...
 */
    public function dog_i4($id){
        ...
        $this->load->view('pagefactopedia/modelsimage/dog_i4',$data);
	} 
 ...
 * ************* This id is returning all the data with id request
 */
        // Update the dog factopedia page
 ...
 * ************* This id is returning all the data with id request
 */   
    public function dogs_do_upload(){ 
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->Dogs_model->dogs_do_upload();
            $this->Dogs_model->dogs_do_upload_first();
 ...
 * ************* This id is returning all the data with id request
 */ 
    public function dogs_do_upload2(){  
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Dogs_model->dogs_do_upload();
            $this->Dogs_model->dogs_do_upload_second();
 ...
 * ************* This id is returning all the data with id request
 */    
    public function dogs_do_upload3(){      
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Dogs_model->dogs_do_upload();
            $this->Dogs_model->dogs_do_upload_third();
 ...
 * ************* This id is returning all the data with id request
 */ 
    public function dogs_do_upload4(){  
		...
		if ( ! $this->upload->do_upload())
		{
            ...
            $this->image_lib->clear();
                ...
                //This two will be executed at the sametime
            $this->Dogs_model->dogs_do_upload();
            $this->Dogs_model->dogs_do_upload_fourth();
